...
rooms = ["courtyard", "guest house", "observatory", "theatre", "drawing room", "garage", "spa", "master bedroom", "studio", "pool", "arcade", "beach house", "surf shop", "kitchen", "ballroom", "conservatory", "billiard room", "library", "study", "hallway", "lounge", "dining room", "cellar", "popes bathroom", "oval office", "graveyard", "roller coaster", "IRC channel", "swimming pool", "motel 6", "garbage can", "mcdonalds bathroom"]
weapons = ["a candlestick","an axe", "a pistol", "rope", "gloves", "a horseshoe", "a knife", "a baseball bat", "a chalice", "a dumbbell", "a wrench", "a trophy", "a pipe", "garden shears", "a claw hammer", "a 2 x 4", "a steering wheel", "a gear shifter", "a lug wrench", "a dell laptop", "a spikey dildo", "a boat anchor", "a bricked windows tablet", "a windows vista install disc", "a casket", "a tony hawk skateboard", "a heading knife", "a gut knife", "a blow up doll", "ceiling fan", "obamas toothbrush"]
